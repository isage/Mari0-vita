...
--			properprint("select mappack", 87*scale, 154*scale)
--			properprint("options", 111*scale, 170*scale)
...
function menu_joystickpressed(joystick, button)
    local bjump = controls[1]["jump"]
    local brun = controls[1]["run"]
    local buse = controls[1]["use"]
    local bleft = controls[1]["left"]
    local bright = controls[1]["right"]
    local bup = controls[1]["up"]
    local bdown = controls[1]["down"]
    local besc = controls[1]["esc"]

    if bjump[1] == "joy" and joystick == tonumber(bjump[2]) and bjump[3] == "but" and button == tonumber(bjump[4]) then
        menu_keypressed("enter",0)
        return
    elseif bup[1] == "joy" and joystick == bup[2] and bup[3] == "but" and button == bup[4] then
        menu_keypressed("up",0)
        return
    elseif bdown[1] == "joy" and joystick == bdown[2] and bdown[3] == "but" and button == bdown[4] then
        menu_keypressed("down",0)
        return
    elseif bright[1] == "joy" and joystick == bright[2] and bright[3] == "but" and button == bright[4] then
        menu_keypressed("right",0)
        return
    elseif bleft[1] == "joy" and joystick == bleft[2] and bleft[3] == "but" and button == bleft[4] then
        menu_keypressed("left",0)
        return
    elseif brun[1] == "joy" and joystick == brun[2] and brun[3] == "but" and button == brun[4] then
        menu_keypressed("escape",0)
        return
    end
